...
* 18: VisualGLM-6B ([model](https://github.com/THUDM/VisualGLM-6B))
...
* 14: Claude, Anthropic ([blog](https://www.anthropic.com/index/introducing-claude)), ChatGLM-6B ([model](https://github.com/THUDM/ChatGLM-6B))
